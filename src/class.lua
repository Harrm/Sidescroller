...
function Class.register(prototype, parent)
    ...
    metatable.__index = parent or function(t, k) error("Nil field "..k.." requested") end
    metatable.__newindex = parent or function(t, k) error("Nil field "..k.." requested") end
